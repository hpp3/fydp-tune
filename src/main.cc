...
void easy_reduce() {
    ...
    std::string kernel = KERNEL_STRING("../examples/kernel/reduce.cl");
...
void tile() {
    ...
    ifstream infile{ "../examples/kernel/multi_tile.cl" };
    ...
    tuner.SetReference({"../examples/kernel/ref.cl"}, "ref", {M, N}, {group_size, group_size});
...
void easy_tile() {
    ...
    std::string kernel = KERNEL_STRING("../examples/kernel/multi_tile.cl");
    cltune::Tuner tuner(size_t{0}, size_t{0});
     tuner.AddKernelFromString(kernel, "multi_tile", {M, N}, {cpack_groupsize, cpack_groupsize});
    //tuner.SetReference({"../examples/kernel/ref.cl"}, "ref", {M, N}, {cpack_groupsize, cpack_groupsize});
...
void easy_mult() {
    ...
    std::string kernel = KERNEL_STRING("../examples/kernel/matrix.cl");
    cltune::Tuner tuner(size_t{0}, size_t{0});
...
void mult() {
    ...
    ifstream infile{ "../examples/kernel/matrix.cl" };
    string kernel{ istreambuf_iterator<char>(infile), istreambuf_iterator<char>() };
...
void rowcol() {
    ...
    ifstream infile{ "../examples/kernel/new_multi.cl" };
    string kernel{ istreambuf_iterator<char>(infile), istreambuf_iterator<char>() };
...
void easy_both() {
    ...
    std::string kernel = KERNEL_STRING_2D("../examples/kernel/multi_tile.cl");
    cltune::Tuner tuner(size_t{0}, size_t{0});
     tuner.AddKernelFromString(kernel, "multi_tile", {M, N}, {cpack_groupsize, cpack_groupsize});
    //tuner.SetReference({"../examples/kernel/ref.cl"}, "ref", {M, N}, {cpack_groupsize, cpack_groupsize});
